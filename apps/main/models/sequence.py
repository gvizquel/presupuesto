...
class Sequence(models.Model):
    ...
    initial = models.PositiveIntegerField(verbose_name=_("initial"), default=1)
    increment = models.PositiveIntegerField(verbose_name=_("increment"), default=1)
    reset = models.PositiveIntegerField(verbose_name=_("reset"), null=True, blank=True)
