...
class MainListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["breadcrumbs"] = [{"url": "", "name": object_name}]
        return context
...
class MainDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["breadcrumbs"] = [
            {"url": "{}:list".format(object_name), "name": "{}".format(verbose_name)}
        ]
...
class MainCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            _("The %(object)s, was succesfully created") % {"object": verbose_name},
        )
...
class MainUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            _("The %(object)s, was succesfully updated") % {"object": verbose_name},
        )
        return super().form_valid(form)
...
class MainDeleteView(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["action_url"] = reverse_lazy(
            "{}:delete".format(object_name), kwargs={"pk": self.object.pk}
        )
        return context
